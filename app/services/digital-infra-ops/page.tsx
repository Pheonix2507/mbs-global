      ...
      <section className="md:hidden bg-[#1F1F1F] py-20 flex flex-col items-center">
        <div className="container mx-auto px-6 max-w-4xl flex flex-col items-center">
          ...
          <div className="w-full max-w-[298px] flex flex-col items-center gap-[31px]">
            {[
              { score: "40%", label: "Savings", desc: "Avg. Infrastructure Cost Savings", offset: 180 },
              { score: "0", description: "Downtime During Migrations", label: "Downtime", offset: 301 },
              { score: "24/7", label: "Monitoring", desc: "Proactive Monitoring", offset: 75 },
              { score: "100%", label: "Compliance", desc: "Compliance Standards Met", offset: 0 }
            ].map((metric, idx) => (
