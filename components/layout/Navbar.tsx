...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center py-6 px-30">
      <div className="flex w-full items-center justify-between px-8 py-3 backdrop-blur-md dark:bg-black/20">
        <Link
          href="/"
