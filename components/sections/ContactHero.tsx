...
const ContactHero = () => {
  return (
    <section className="relative flex flex-col items-center pt-[153px] pb-16 px-[26px] overflow-hidden bg-[#1F2123] min-h-[500px]">
      {/* Background glow */}
      ...
      >
        <div className="w-full h-full bg-[#1F2123] rounded-[15px] flex items-center justify-center py-[8px] px-[16px]">
            <span className="text-white text-[14px] font-normal font-sans capitalize leading-none">Contact us</span>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center w-full max-w-[362px] min-h-[261px] md:max-w-[1199px] md:min-h-[131px] gap-[40px] z-10 transition-all">
        ...
        {/* Description */}
        <p className="font-sans font-normal text-center text-zinc-300 text-[16px] md:text-[20px] leading-[120%] tracking-[0%] m-0">
